<<<<<<< HEAD:app/views/media/search/layouts/hb-annotatedmetadatadescription.blade.php
...
=======
<div class='hidden' id='modalIndividualMetadata'>
>>>>>>> origin/media-view:app/views/media/search/layouts/hb-modalindividualmetadata.blade.php
	<script class='template' type="text/x-handlebars-template">
		<!-- Modal -->
