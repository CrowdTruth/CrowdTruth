					...
					<div class="panel-body">
						...
						<div id="cf-div" style="padding: 10px;">
							<fieldset>
								...
								{{ Form::label('annotationsPerWorker', 'Max annotations per worker', array('class'=>'col-xs-4 control-label', 'data-toggle'=> 'tooltip', 'title'=>'Amount of units a worker is allowed to annotate')) }}
