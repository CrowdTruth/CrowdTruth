							...
							<div class='table-responsive'>
								...
								?>
									<tr>
										...
										<td>{{ link_to('files/browse/' . $entity->fileType, $entity->fileType) }}</td>										
										<td>{{ link_to('files/browse/' . $entity->fileType . '/' . $entity->domain, $entity->domain) }}</td>										
										<td>{{ link_to('files/browse/' . $entity->fileType . '/' . $entity->domain . '/' . $entity->documentType, $entity->documentType) }}</td>										
