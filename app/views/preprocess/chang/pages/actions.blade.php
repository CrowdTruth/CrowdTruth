...
@section('changContent')
				<!-- START preprocess/chang/actions --> 
							...
							<div class='table-responsive'>
								...
								@foreach ($entities as $entity)
									<tr>
										...
										<td>
<a class='btn btn-success' href='{{ URL::to('preprocess/chang/preview?URI=' . $entity['_id']) }}'><i class="fa fa-search fa-fw"></i>Preview</a>
<a class='btn btn-success' href='{{ URL::to('preprocess/chang/process?URI=' . $entity['_id']) }}'><i class="fa fa-gear fa-fw"></i>Process</a>
										</td>
									</tr>
								@endforeach
...
<a class='btn btn-success' href='{{ URL::to('preprocess/chang/process?URI=' . $entity['_id']) }}'><i class="fa fa-gears fa-fw"></i>Process All</a>
										</td>
									</tr>
									</tbody>
								</table>
							</div>
				<!-- STOP preprocess/chang/actions --> 				
@stop