			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li{{ (Request::segment(1) == 'jobs' ? ' class="active"' : '') }} data-toggle="tooltip" data-placement="bottom" id="jobTabOption" title="View Existing Job Analytics <br /> Create New Jobs">
						{{ link_to('jobs', "Jobs") }}</li>
						<li{{ (Request::segment(1) == 'workers' ? ' class="active"' : '') }} data-toggle="tooltip" data-placement="bottom"  id="workerTabOption"  title="View Worker Analytics">
