				...
				<div class="panel panel-default">		
					...
					<div class="panel-body">
			  		...
			  		<p>Displaying templates with format <b>{{$format}}</b>, based on the selected batch.</p>
						...
						<br>
						<br>
						{{ Form::open(array('class' => 'form-horizontal jobconf', 'action' => array('JobsController2@postFormPart', 'platform'), 'method' => 'POST'))}}
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
								<div class="form-group">
									{{ Form::open(array('action' => 'JobsController2@postUploadTemplate', 'files' => 'true')) }}
