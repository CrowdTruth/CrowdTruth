  ...
  angular.module('builder.components', ['builder', 'validator.rules']).config([
    '$builderProvider', function($builderProvider) {
      $builderProvider.registerComponent('textInput', {
        ...
        template: "<div class=\"form-group\"><label for=\"{{formName+index}}\" class=\"col-md-4 control-label\">{{label}}</label><div class=\"col-md-8\">\n <input type=\"text\" id=\"{{formName+index}}\" class=\"form-control\" placeholder=\"{{placeholder}}\"/>\n        <p class='help-block'>{{description}}</p>\n    </div>\n</div>",
